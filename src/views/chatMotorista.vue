<template>
  <div class="chat-container">
    ...
    <div class="message-buttons">
      <button
        v-for="presetMessage in presetMessages"
        :key="presetMessage"
        class="preset-button"
...
// Nova mensagem digitada pelo motorista
...
const presetMessages = ref([
  'Estou atrasado.',
  'Estou chegando.',
  'Trafego intenso, peço paciência.',
  'Já estou no local combinado.',
]);

// Função para enviar mensagens padrão
